angular.module('Compasstic', ['ionic', 'Compasstic.controllers', 'Compasstic.factories'])
...
.config(function($stateProvider, $urlRouterProvider) {
  $stateProvider
      ...
      .state('app.queryReuslt', {
      url: '/queryReuslt',
      views: {
          'menuContent': {
              templateUrl: 'templates/queryReuslt.html',
              controller: 'queryReusltCtrl'
          }
      }
  })
      .state('app.history', {
